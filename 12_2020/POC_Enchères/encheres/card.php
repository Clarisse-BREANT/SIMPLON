...
<div class='card-container col-lg-4 col text-center my-4'>
    <div class='card'>
        ...
        <div class='card-body'>
            <h5 class='card-title font-weight-bold' style='color:red;'><?php echo $this->m_price; ?>€</h5>
            <img class='card-img' src="<?php echo $this->m_image; ?>" alt="Iphone">
            <p class='card-text font-weight-bold' style='color:red;'><?php echo date("d\J H\h i\m s\s", $this->m_time - time() - 3600*3)?> </p>
            <form method="POST">
