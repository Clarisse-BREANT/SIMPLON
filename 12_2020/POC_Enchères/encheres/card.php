...
<div class='card-container col-lg-3 col text-center'>
    <div class='card'>
        ...
        <div class='card-body'>
            ...
            <p class='card-text font-weight-bold' style='color:red;'>Temps restant : <?php echo date("H:i:s", $this->m_time - time())?> </p>
            <form method="POST">
